  ...
  fetch("/api/top_parkour", {
    ...
    .then((res) => {
      ...
      for (let i = 0; i < scores.length; i++) {
        ...
        skull.src = `https://mc-heads.net/avatar/${scores[i].nick}/50.png`;
        ...
        if (i < 5) document.getElementById("stat1").appendChild(newStat);
        else document.getElementById("stat2").appendChild(newStat);
      }
    });
}
